...
\end{figure}
    ...
    In their original work, Hwang et. al. located the ground station for receiving data in Ann Arbor, 
    Michigan. However, the satellite was launched into a polar orbit so moving the ground station 
    closer to one of the polls would help to improve the amount of data collected. McMurdo Station, 
    ...
    station over these six design points. There were seven design variables listed in Tab.~\ref{eqn:cadre_formulation}.
    ...
    \subsection{Optimization Results}
        ...
        \subsection{Performance Results}
            ...
            Figure \ref{convergence} shows function evaluation history of the satellite problem over the course of
            the optimization between the full and reduced graph cased. The top plot shows the value of the objective function, the total data downloaded.
            ...
            to be so significant for all problems. Also, the overall cost of the optimizer would get less significant as the 
