...
\end{figure}
    ...
    \subsection{Optimization Results}
        ...
        The final optimal design yielded 22843 GibaBytes (GB) total data downloaded over the 6 time points considered. 
        ...
        \subsection{Performance Results}
            ...
            yielded a drop in runtime of about 20\%. 
            ...
            \begin{table}
                ...
                325 function evaluations}
                  \begin{tabular}{l c c c}
                      ...
                      Total Run Time (hours) & 10.68 & 8.94 & 21.3\%\\ 
                      \bottomrule
                  \end{tabular}    
  ...
  \section{Wind Turbine Design Problem}
    ...
    \subsection{Performance Results}
        This optimization was run with both finite-difference and mixed analytic/finite-difference gradients.  The problem was converged to a termination tolerance of $5\times10^{-5}$ using SNOPT.  For this problem, finite-difference achieved almost the same optimum design that the analytic gradients case found, and had the same level of feasibility. The major advantage of the analytic gradients was 5x reduction in computational time. Figure \ref{fig:wt-opt-progress} shows optimization
        ...
        \begin{table}
            ...
            \begin{tabular}{lrr}
                ...
                $||$Constraints$||_2$                 & $3.70\times10^{-6}$ & $2.32\times10^{-6}$  \\ 
