...
\end{minipage}
  ...
  \section{Wind Turbine Design Problem}
    ...
    \begin{figure}[htbp]
      \centering
      \includegraphics[width=0.95\textwidth]{images/wt-opt-history}
      \caption{Objective value over the course of the optimization for the wind turbine design problem.}
      \label{fig:wt-opt-history}
    \end{figure}
