...
\end{figure}
    ...
    \subsection{Optimization Results}
        ...
        \subsection{Performance Results}
            ...
            shows a log-log plot of computational cost for 31 adjoint solves (30 constraints + 1 objective) versus the 
  ...
  \section{Conclusion}
      ...
      The results from that problem reveal that the implementation scales well to large problems and a significant 
      computational cost benefit could be obtained from taking advantage of sparsity in the problem formulation. The wind turbine design 
      problem had a smaller design space, a more complex problem formulation, and used a combination of finite-difference and analytic gradients. 
      The problem was solved with forward gradients because it had more constraints than design variables.
      Results from this problem showed a clear advantage in terms of achieving computational efficiency by applying
      analytic derivatives, even to only some of the disciplines. In addition, the results demonstrated OpenMDAO's ability
      to solve highly nested problems with coupled derivatives. 
