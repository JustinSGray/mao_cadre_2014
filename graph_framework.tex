...
\begin{document}
  ...
  and construct a more flexible implementation. For this work the problem is broken down into 15 disciplines, 
  shown in Figure \ref{fig:aero-struct-xdsm}. 

  \begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{images/allpts_map_data.png}
    \caption[width=0.4\textwidth]{Aero-structural problem formulation given in XDSM form
    \label{fig:aero-struct-xdsm}
    }
  \end{figure}
