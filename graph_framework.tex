...
\end{minipage}
    ...
    \subsection{Optimization Results}
        ...
        \subsection{Performance Results}
            ...
            cost compared to the original implementation by Hwang et. al. 
            ...
            reduction in the overall computational cost of solving derivatives. While the overall reduction 
            in computation time is over 1 order of magnitude, a simple comparison of the compute times 
            for a derivative evaluation of the objective function between the reduced and full variable set 
            shows only a 40\% reduction. The remaining computation savings can only be accounted for by looking 
            at the cost of each iteration over the course of an entire optimization. 
            ...
            here are a number of components which
  ...
  \section{Wind Turbine Design Problem (Justin/Andrew)}
    ...
    But at worse, the discrete non-relevant variables would prevent the system from working properly at all. 
